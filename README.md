...
A PostgreSQL backup file of the used dataset is available at Zenodo repository (10.5281/zenodo.15329750) in the `db/` directory. It can be restored using `pg_restore` and includes all tables used to train VEFill.
...
The following pretrained VEFill models are available at Zenodo repository (10.5281/zenodo.15329750) in the `models/` directory:
